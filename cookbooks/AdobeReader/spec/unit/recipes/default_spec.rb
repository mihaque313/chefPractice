...
describe 'jnj_mssql_odbc::windows' do
  let(:chef_run) do
    ChefSpec::SoloRunner.new(platform: 'windows', version: '2012R2') do |node|
      node.default['jnj_mssql_odbc']['sourcepath'] = 'http://http://itsusablsp00956.jnj.com/jnj-dvl-opcx-scm/packages/odbc/13.1.4414.46/64bit'
      ...
      node.default['jnj_mssql_odbc']['current_version'] = current_version
